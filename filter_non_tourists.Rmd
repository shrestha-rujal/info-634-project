...
setwd(paste(getwd(), "/INFO-634/info-634-project"))
```
...
secondary_purpose_of_visit <- read.csv(
  "./INFO-634/info-634-project/datasets/secondary_purpose_of_visit.csv",
  header = TRUE
)
...
survey_main_header <- read.csv(
  "./INFO-634/info-634-project/datasets/survey_main_header.csv",
  header = TRUE
)
